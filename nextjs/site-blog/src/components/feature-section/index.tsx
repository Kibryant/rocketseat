...
export function FeatureSection() {
  return (
    <section className="grid gap-6 md:grid-cols-2 pb-8 pt-8 md:py-10 mx-auto px-4 max-w-7xl">
      <div className="flex flex-col gap-4 rounded-lg p-6 bg-gray-500 md:p-12">
        ...
        <h2 className="text-gray-100 text-3xl leading-tight font-bold">
      ...
      <div className="col-span-full flex flex-col gap-2">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-4 rounded-lg bg-gray-500 p-6 md:p-12">
          <div className="flex flex-col gap-4">
            ...
            <Button
              asChild
              className="w-fit rounded-full hidden mt-4 md:mt-auto md:flex bg-blue-400 hover:bg-blue-500"
            >
