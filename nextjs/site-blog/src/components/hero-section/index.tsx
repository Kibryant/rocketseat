...
export function HeroSection() {
  return (
    <section className="mt-16 md:mt-32 lg:mt-40 px-4 lg:px-0 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 min-h-80 md:h-144 items-center">
        <div className="flex flex-col items-center justify-center gap-4 md:items-start lg:items-start">
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center md:text-left lg:text-left leading-tight">
          ...
          <div className="flex flex-col items-center justify-center gap-4 md:items-start lg:items-start">
            <div>
              <div className="flex items-center gap-2">
                <Clock className="text-cyan-500 h-4 w-4" />
              ...
              <div className="flex items-center gap-2">
                <Store className="text-cyan-500 h-4 w-4" />
                <span className="text-gray-200">
            ...
            <div className="text-white flex flex-col gap-2 mt-5 items-center md:items-start ls:items-start">
              <Button className="rounded-full w-fit bg-blue-500 hover:bg-blue-600 px-6 py-3" asChild>
