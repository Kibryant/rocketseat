...
export default function PostPage() {
  ...
  return (
    <main className="mt-32 text-gray-100 max-w-7xl mx-auto px-8 sm:px-16 lg:px-24 pb-16 lg:pb-32">
      <div className="container space-y-12 px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_300px] gap-6 lg:gap-12">
          <article className="rounded-lg overflow-hidden border-gray-400 border">
